...
def run():
    locations = ["Thanh pho Ho Chi Minh, VN","Sydney, AU","Singapore, SG"]
    iterator = 0
    ...
    while True:
        ...
        # Handle weather of array instead of string 
        if isinstance(current_weather['description'], list):
            current_weather['description'] = ','.joins(current_weather['description'])
        ...
        print("New weather report of", location, "sent")
